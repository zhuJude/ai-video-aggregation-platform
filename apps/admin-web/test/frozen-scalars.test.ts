...
describe('frozen scalar mirrors', () => {
  ...
  it.each(['', '-1', '+1', '01', '1.0', '1.25', '1e3', 'NaN', 'Infinity'])('rejects noncanonical points %s', (value) => {
  ...
  it.each(['2026-08-31T16:00:00+08:00', '2026-08-31T08:00:00', '2026-02-30T08:00:00Z', 'not-a-date'])('rejects non-UTC or invalid timestamp %s', (value) => {
