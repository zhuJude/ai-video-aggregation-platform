...
test('fixture rejects unsupported methods for every known endpoint', async ({ request }) => {
  const knownPaths = [
    ...
    '/admin/pricing/current', '/admin/pricing/preview', '/admin/pricing/publish',
    '/admin/routing/current', '/admin/routing/simulate', '/admin/tasks', `/admin/tasks/${IDS.task}`, `/admin/tasks/${IDS.task}/raw`,
