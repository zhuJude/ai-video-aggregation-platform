...
if (typeof PrismaClient !== 'function') throw new Error('PRISMA_CLIENT_CONSTRUCTOR_UNAVAILABLE');

const adapter = new PrismaPg({
  connectionString: 'postgresql://iam_build:iam_build@127.0.0.1:5432/iam_build',
});
...
log('IAM Prisma compiled runtime probe passed.');
